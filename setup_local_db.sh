...
echo "   2. Скопируйте .env.local.example в .env"
echo "   3. Заполните TELEGRAM_BOT_TOKEN в .env"
echo "   4. Запустите приложение: npm run dev"
echo ""
echo "⚠️  ВАЖНО: Убедитесь что установлен dotenv (npm install dotenv)"
echo "   Без этого приложение не сможет прочитать .env файл!"